...
// Global variable to hold methods from the 'lib_vcdcli.groovy' file.
                ...
                script {
                    try {
                        ...
                        if (OVERRIDE_GIT_REPOSITORY == '') {
                            OVERRIDE_GIT_REPOSITORY = 'git@github.com:vmware/vcd-cli.git'
                        }
        ...
        stage('prepare') {
            steps {
                script {
                    ...
                    externalMethods = load 'support/lib_vcdcli.groovy'
                }
            }
        }
        stage('install') {
